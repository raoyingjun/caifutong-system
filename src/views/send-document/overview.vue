<template>
  <base-card label="外部收文">
    <el-form :inline="true" label-width="85px" class="mt-24" :form="form">
      <el-row>
        <el-col :span="8">
          <el-form-item label="行文名称">
            <el-input v-model="form.docName" placeholder="请输入文档名称" />
          </el-form-item>
        </el-col>
        <el-col :span="8" class="justify-center">
          <el-form-item label="行文主体">
            <base-select v-model="form.emergencyDegree" placeholder="全部" option-label="key" :options="[]" />
          </el-form-item>
        </el-col>
        <el-col :span="8" class="justify-end">
          <el-form-item label="行文对象" style="margin-right: 0">
            <el-input v-model="form.docName" placeholder="请输入文本" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row justify="space-between">
        <el-col :span="8">
          <el-form-item label="行文主笔">
            <el-input v-model="form.receiveDepartmentName" placeholder="请输入文档名称" />
          </el-form-item>
        </el-col>
        <el-col :span="8" class="justify-center">
          <el-form-item label="审批状态">
            <base-select v-model="form.type" placeholder="全部" option-label="key" :options="[]" />
          </el-form-item>
        </el-col>
        <el-col :span="8" class="justify-end">
          <el-form-item label="行文时间" style="margin-right: 0">
            <el-date-picker
              v-model="timeRange"
              style="width: 432px"
              type="daterange"
      ...
      <el-row>
        <el-col :span="8" :offset="16" class="justify-end">
    ...
    >
      ...
      <el-table-column label="行文名称" prop="SerialNum" show-overflow-tooltip></el-table-column>
      <el-table-column label="行文主体" prop="ExternalDocName"></el-table-column>
      <el-table-column label="行文对象" prop="SendDepartment" show-overflow-tooltip></el-table-column>
      <el-table-column label="收文创建人" prop="SendDepartment" show-overflow-tooltip></el-table-column>
      <el-table-column label="行文时间" prop="CreateTime" width="153"></el-table-column>
      <el-table-column
        label="审批状态"
        :formatter="({ Type }) => findLabelByValue(Type, $store.state.incomingDocTypes, ['key', 'value'])"
      ></el-table-column>
      <el-table-column label="当前处理人" prop="CreatedName" show-overflow-tooltip></el-table-column>
      <el-table-column label="操作" width="210">
        <template #default="{ row, $index }">
          ...
          <el-button type="primary" link>加处理人</el-button>
          <el-button type="primary" link>修订重提</el-button>
          <el-button type="primary" link>发起会签</el-button>
          <el-button type="primary" link>下载</el-button>
          <el-button type="primary" link>发起用印</el-button>
          <el-button type="primary" link>重新发起</el-button>
        </template>
      </el-table-column>
    </base-table>
  </base-card>
